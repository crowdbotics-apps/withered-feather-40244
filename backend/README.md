...
## Project Structure
    ...
    ├── withered_feather_40244  # Django project configurations
...
1. Clone this repo and `cd withered_feather_40244`
...
2. Clone this repo and `cd withered_feather_40244`
