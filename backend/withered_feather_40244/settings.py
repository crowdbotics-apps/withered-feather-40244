"""
Django settings for withered_feather_40244 project.
...
ROOT_URLCONF = 'withered_feather_40244.urls'
...
WSGI_APPLICATION = 'withered_feather_40244.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_feather_40244 API",
    "DESCRIPTION": "API documentation for withered_feather_40244 App",
    "VERSION": "v1",
}
